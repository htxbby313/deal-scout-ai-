...
export type RadarMapSignal = { id: string; fips: string; stateFips: string; countyName: string; stateName: string; currentUnits: number; growthPct: number | null; currentValue: string; sourceUrl: string };
