...
export function PropertyBrowser({ properties }: { properties: PropertyView[] }) {
  ...
  const [mapColor, setMapColor] = useState("#2563eb");
  const rankCategory = sort === "confidence" ? "Highest confidence" : sort === "price-asc" ? "Lowest price" : sort === "price-desc" ? "Highest price" : sort === "address" ? "Address A–Z" : "Most researched";
