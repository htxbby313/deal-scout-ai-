...
export function PropertyBrowser({ properties }: { properties: PropertyView[] }) {
  ...
  return <>
    ...
    <div className="mt-5"><PropertyMap baseColor={mapColor} onSelect={setSelectedId} properties={regionFiltered} rankCategory={rankCategory} /></div>
